...
public class SaveMenu : MonoBehaviour {
    ...
    public ConfirmDialog confirmDialog = new();
    ...
    void Start() {
        ...
        audioElement = new(sounds, volumes, "SaveMenu", null);
    }
...
        //set saveName to be name selected in list if selection has changed
    ...
    private float GetMenuItemsHeight() => ResourceManager.ButtonHeight + ResourceManager.TextHeight + 3 * ResourceManager.Padding;
